...
dd if=/dev/urandom of=$1/foobar512M oflag=direct bs=1M count=700
dd if=/dev/urandom of=$1/foobar512M oflag=direct bs=1M count=800
dd if=/dev/urandom of=$1/foobar512M oflag=direct bs=1M count=850
dd if=/dev/urandom of=$1/foobar512M oflag=direct bs=1M count=900
dd if=/dev/urandom of=$1/foobar512M oflag=direct bs=1M count=950
